...
Go1Robot::Go1Robot(){
    _Legs[0] = new Go1Leg(0, Vec3( 0.3274, -0.08765, 0));
    _Legs[1] = new Go1Leg(1, Vec3( 0.3274,  0.08765, 0));
    _Legs[2] = new Go1Leg(2, Vec3(-0.3274, -0.08765, 0));
    _Legs[3] = new Go1Leg(3, Vec3(-0.3274,  0.08765, 0));
