#ifndef LOWLEVEL_STATE_HPP
#define LOWLEVEL_STATE_HPP
...
struct MotorState {
    ...
    MotorState() : q(0), dq(0), ddq(0), tauEst(0) {}
};
...
struct IMU {
    ...
    // Methods for returning rotation matrix, acceleration, gyroscope, and quaternion
    RotMat getRotMat() {
        Quat quat;
